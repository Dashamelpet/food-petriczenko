...
window.addEventListener('DOMContentLoaded', () => {
  const modalInterval = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__.openModal)('.modal', modalInterval), 3000);
  console.log('hello1');
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__["default"])('2025-02-6');
});
})();
